const levels =[ 
	...
	//level 3
	["jaildoor","wall","animate","animate","animate",
	"coin","lava","","lava","",
	"wall","lava","soldier-up","lava","key",
	"coin","lava","","lava","coin",
	"znimate","znimate","znimate","znimate","znimate"]
...
function showPause (){
	animatedBoxes = document.querySelectorAll(".animate");
...
function resumeGame(){
	...
	animateEnemy(animatedBoxes, currentLocationofEnemy, directionOfEnemy);
}
